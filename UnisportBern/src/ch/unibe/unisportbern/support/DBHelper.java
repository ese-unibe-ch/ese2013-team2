...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		sql = String.format("CREATE TABLE %s (cid INTEGER PRIMARY KEY AUTOINCREMENT, sid INTEGER, day TEXT, time TEXT, offer TEXT, location TEXT, information TEXT, subscription INTEGER)", COURSES);
		db.execSQL(sql);
