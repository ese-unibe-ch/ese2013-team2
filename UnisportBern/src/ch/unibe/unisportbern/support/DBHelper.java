...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		sql = String.format("CREATE TABLE %s (cid INTEGER PRIMARY KEY AUTOINCREMENT, sid INTEGER, time TEXT, day TEXT, p1 INTEGER, p2 INTEGER, p3 INTEGER, p4 INTEGER, p5 INTEGER, location TEXT, information TEXT, sub INTEGER, kew INTEGER)", COURSES);
		db.execSQL(sql);
